...
public class PauseMenu : MonoBehaviour
{
    ...
    private PlayerController playerFPSController;
    ...
    void Start()
    {
        playerFPSController = player.GetComponent<PlayerController>();
